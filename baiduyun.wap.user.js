...
;(function () {
    ...
    function PanShareHelper() {
        var yunData, sign, timestamp, bdstoken, channel, clienttype, web, app_id, logid, uk,
            fid_list, shareid, vcode, shorturl;
        ...
        function addButton() {
            var $button = '<button id="panShareHelper" style="height: 42px;padding: 0 40px;font-size: 16px;font-weight: 700;color: #F9F9F9;border-radius: 23px;background-color: #ff4a06;margin: 20px auto;display: block;">下载助手</button>';
